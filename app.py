...
tabs = ["Overview", "HRC & Zinc", "Margin & Risk", "Supply Sources"]
selected_tab = st.tabs(tabs)

# Data mẫu (thay bằng Google Sheet sau)
data = pd.DataFrame({
    'Month': ['Sep 2026', 'Aug 2026', 'Jul 2026', 'Jun 2026'],
    'HRC_Price': [510, 505, 515, 500],
    'Zinc_Price': [3240, 3200, 3180, 3300],
    'Margin_%': [18.5, 19.2, 17.8, 20.1],
    'Completion_Rate_%': [67, 68, 66, 69],
    'Orders': [9999, 8710, 8370, 8190],
    'Revenue_M': [24.78, 21.0, 20.6, 19.7],
    'Source': ['Ấn Độ', 'CSVC Phú Mỹ', 'Trung Quốc', 'Hàn Quốc']
})
